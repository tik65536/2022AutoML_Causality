...
estimator_list = "all"
out_dir = "./../result/02_LRL1"
filename_out = "synthetic_observational_cate"
_datapath = "./../DataSet"
_data_file = sys.argv[1]
_file_suffix = _data_file.split(".")[0].split("_")[2]
...
"""
data = None
with open(Path(_datapath, _data_file), "rb") as f:
    data = pickle.load(f)
...
for metric in metrics:
    ...
    with open(Path(out_dir, f"{filename_out}_{metric}_run_{_file_suffix}.pkl"), "wb") as f:
